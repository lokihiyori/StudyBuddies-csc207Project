...
public class makeEventInteractor implements makeEventInputBoundary{
    ...
    public makeEventInteractor(makeEventDataAccessInterface eventDataAccessObject, makeEventUserDataAccessInterface
            userDataAccessObject, makeEventOutputBoundary createEventPresenter, CalendarEventFactory calendarEventFactory) {
    ...
    public void execute(makeEventInputData makeEventInputData) {
        if (eventDataAccessObject.existsByName(makeEventInputData.getEventName())) {
            ...
            CalendarEvent event = calendarEventFactory.create(makeEventInputData.getEventName(), makeEventInputData.getEventDate(),
                    makeEventInputData.getEventEndDate(), makeEventInputData.getEventTime(), makeEventInputData.getEventEndTime(), makeEventInputData.getOrganiserName(),makeEventInputData.getLocation());
